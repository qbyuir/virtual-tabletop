...
%o`, message, error2, detail);
  ...
  // app/javascript/engine/CanvasEngine.js
  ...
  // app/javascript/engine/Camera.js
  var Camera = class {
    constructor(stage) {
      this.stage = stage;
      this.minScale = 0.1;
  ...
  // app/javascript/engine/ToolManager.js
  ...
  // app/javascript/managers/TokenManager.js
  ...
  // app/javascript/managers/HistoryManager.js
  ...
  // app/javascript/actions/PasteTokenAction.js
  var PasteTokenAction = class {
  ...
  // app/javascript/actions/MoveTokenAction.js
  var MoveTokenAction = class {
  ...
  // app/javascript/objects/Token.js
  var Token = class {
    constructor(layer, url, x, y, history2) {
  ...
  // app/javascript/managers/PasteManager.js
  ...
  // app/javascript/tools/SelectTool.js
  var SelectTool = class {
    ...
    enable() {
      ...
      let dragOffsets = /* @__PURE__ */ new Map();
      this.stage.on("mousedown.select", (e) => {
        ...
        const clicked = tokens.find((token) => {
          ...
          return worldPos.x >= box.x && worldPos.x <= box.x + box.width && worldPos.y >= box.y && worldPos.y <= box.y + box.height;
        });
        if (!clicked) {
  ...
  // app/javascript/tools/PanTool.js
  var PanTool = class {
    constructor(stage) {
      this.stage = stage;
